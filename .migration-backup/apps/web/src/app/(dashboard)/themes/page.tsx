        ...
        {BUILT_IN_THEMES.map(theme=>{
          ...
          return (
            <div key={theme.id}
              ...
              className={`rounded-2xl overflow-hidden cursor-pointer transition-all hover:-translate-y-1 hover:shadow-xl ${isActive?'ring-2 ring-offset-2':''}`}
              style={{borderColor:isActive?'var(--color-primary)':'var(--card-border)',border:`2px solid`,ringColor:isActive?'var(--color-primary)':'transparent'}}>
