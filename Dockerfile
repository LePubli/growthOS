# ============================================================
# GrowthOS — Frontend (Vite + React → nginx static)
...
# VITE_API_URL : URL of your backend, e.g. https://api.yourdomain.com
...
# ── Free build artefacts no longer needed ────────────────────
